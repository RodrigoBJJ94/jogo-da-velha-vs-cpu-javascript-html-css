    ...
    if (playing) {
        ...
        if (level === 1) {
            ...
            if ((game[0][0] === 'O') && (game[0][1] === 'O') && (game[0][2] === '')) {
                ...
                game[1][1] = 'O';
            } else if ((game[0][2] === 'X') && (game[0][1] === '') && (game[0][0] === '') && (game[1][0] === '') && (game[1][1] === '') && (game[1][2] === '') && (game[2][0] === '') && (game[2][1] === '') && (game[2][2] === '')) {
                game[1][1] = 'O';
            } else if ((game[1][0] === 'X') && (game[0][1] === '') && (game[0][2] === '') && (game[0][0] === '') && (game[1][1] === '') && (game[1][2] === '') && (game[2][0] === '') && (game[2][1] === '') && (game[2][2] === '')) {
                game[1][1] = 'O';
            } else if ((game[1][2] === 'X') && (game[0][1] === '') && (game[0][2] === '') && (game[1][0] === '') && (game[1][1] === '') && (game[0][0] === '') && (game[2][0] === '') && (game[2][1] === '') && (game[2][2] === '')) {
                game[1][1] = 'O';
            } else if ((game[2][0] === 'X') && (game[0][1] === '') && (game[0][2] === '') && (game[1][0] === '') && (game[1][1] === '') && (game[1][2] === '') && (game[0][0] === '') && (game[2][1] === '') && (game[2][2] === '')) {
                game[1][1] = 'O';
            } else if ((game[2][1] === 'X') && (game[0][1] === '') && (game[0][2] === '') && (game[1][0] === '') && (game[1][1] === '') && (game[1][2] === '') && (game[2][0] === '') && (game[0][0] === '') && (game[2][2] === '')) {
                game[1][1] = 'O';
            } else if ((game[2][2] === 'X') && (game[0][1] === '') && (game[0][2] === '') && (game[1][0] === '') && (game[1][1] === '') && (game[1][2] === '') && (game[2][0] === '') && (game[2][1] === '') && (game[0][0] === '')) {
                game[1][1] = 'O';
            } else if ((game[1][1] === 'X') && (game[0][1] === '') && (game[0][2] === '') && (game[1][0] === '') && (game[0][0] === '') && (game[1][2] === '') && (game[2][0] === '') && (game[2][1] === '') && (game[0][0] === '')) {
                game[0][2] = 'O';
